...
Part of my AI / SDET transition portfolio → **[ai-career-journey](https://github.com/satnil2608-glitch/ai-career-journey)**
...
Shows SDET fundamentals: reusable client, clear assertions, Pytest fixtures, and (soon) CI.  
...
```powershell
git clone https://github.com/satnil2608-glitch/api-automation-pytest.git
